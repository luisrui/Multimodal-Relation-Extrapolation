...
class Multimodal_Encoder(nn.Module):
    ...
    def _init_embedding(self):
        ...
        for index, entity in tqdm(enumerate(self.entity2id)):
            ...
            try:
                ...
                with open(f"./data/{dataset}/img_em/" + entity_ + "/avg_embedding.pkl", "rb") as visef:
                    embed = embed+1
    ...
    def _init_tokens(self):
        ...
        with open(f'../origin_data/{dataset}/M3AE_embed.pkl', 'rb') as fin:
            self.m3ae_tokens = pickle.load(fin)
        ...
        for index, entity in tqdm(enumerate(self.entity2id)):
            ...
            mm_tokens.append(ent_tokens)

        return torch.stack(mm_tokens)
...
class TransE(nn.Module):
    def __init__(self, ent_tot, rel_tot, dim = 100, p_norm = 1, norm_flag = True, margin = None, epsilon = None):
        ...
        self.ent_embeddings = Multimodal_Encoder(dim = self.dim, margin = self.margin, epsilon = self.epsilon)
