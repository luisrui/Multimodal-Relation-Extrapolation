...
class Trainer(object):
    ...
    def build_connection(self, max_=100):
        ...
        with open(self.data_path + "train.tsv") as f:
            lines = f.readlines()
    ...
    def eval(self, mode="dev", meta=True, load_pretrain=False):
        if load_pretrain:
            self.load_pretrain()
            self.load()
        self.Generator.eval()
