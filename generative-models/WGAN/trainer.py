...
class Trainer(object):
    def __init__(self, args):
        ...
        rela_matrix = np.load(self.data_path + self.dataset + "rela_matrix.npz")["relaM"]
    ...
    def load_embed(self):
        ...
        if self.embed_model in ["DistMult", "TransE", "ComplEx", "RESCAL"]:
            ...
            json.dump(
                symbol_id,
                open("origin_data/NELL/Embed_used/" + self.embed_model + "2id", "w"),
            )
    ...
    def eval(self, mode="dev", meta=True):
        ...
        for query_ in test_candidates.keys():
            ...
            relation_vecs = relation_vecs.cpu().numpy()
