...
def read_options():
    ...
    parser.add_argument("--dataset", default="OpenBG-IMG", type=str)
    ...
    parser.add_argument(
        "--ep_dim", default=200, type=int, help="dimension of entity pair embedding"
    )
    ...
    parser.add_argument("--pretrain_few", default=5, type=int)
    parser.add_argument("--pretrain_subepoch", default=20, type=int)
    parser.add_argument(
        "--pretrain_margin", default=10.0, type=float, help="pretraining margin loss"
    )
    parser.add_argument(
        "--pretrain_times",
        default=500,
